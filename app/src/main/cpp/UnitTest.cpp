...
void UnitTest::UT_CaffeEva(void) {
  ...
  if (kCaffeModelName == "AlexNet") {
    ...
    caffeEvaObj.SetModelPath("/storage/emulated/legacy/Q_CNN/AlexNet/Bin.Files", "bvlc_alexnet_aCaF");
    caffeEvaObj.LoadDataset("/storage/emulated/legacy/Q_CNN/ILSVRC12.227x227.IMG");
